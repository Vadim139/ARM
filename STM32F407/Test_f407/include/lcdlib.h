...
#define LCD_RESET_LOW GPIO_PinRes(SPIPORT,RESET);
#define LCD_RESET_HIGH GPIO_PinSet(SPIPORT,RESET);
// mask definitions
...
//void LCDPutStr (char *lcd_string, unsigned char x, unsigned char y, const char *font_style,char back, unsigned char fcolor, unsigned char bcolor);
#endif /* LCD_H_ */
...
void LCDWriteKamamiBmp(void);// z³e
