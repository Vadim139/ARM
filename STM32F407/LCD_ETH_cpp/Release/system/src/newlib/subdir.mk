...
system/src/newlib/%.o: ../system/src/newlib/%.cpp
	...
	arm-none-eabi-g++ -mcpu=cortex-m4 -mthumb -mfloat-abi=soft -Os -fmessage-length=0 -fsigned-char -ffunction-sections -fdata-sections -Wall -Wextra  -g -DOS_USE_SEMIHOSTING1 -DRELEASE -DSTM32F40_41xxx -DOS_USE_TRACE_SEMIHOSTING_DEBUG1 -DSTM32F407xx -DUSE_HAL_DRIVER1 -DHSE_VALUE=8000000 -I"../include" -I"../system/include/stm32f4" -I"../system/include" -I"../system/include/cmsis" -I"../system/include/stm32f4-hal" -std=gnu++11 -fabi-version=0 -fno-exceptions -fno-rtti -fno-use-cxa-atexit -fno-threadsafe-statics -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -c -o "$@" "$<"
